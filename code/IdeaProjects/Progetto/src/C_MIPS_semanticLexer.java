...
public class C_MIPS_semanticLexer extends Lexer {
	...
	public final void mSLASH() throws RecognitionException {
		try {
			// C:\\GitHub\\unibg-compilers\\code\\IdeaProjects\\Progetto\\src\\C_MIPS_semantic.g:218:18: ( '\\\\' )
			// C:\\GitHub\\unibg-compilers\\code\\IdeaProjects\\Progetto\\src\\C_MIPS_semantic.g:218:20: '\\\\'
			{
			match('\\'); 
			}
	...
	public final void mCHAR_QUOTE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\GitHub\\unibg-compilers\\code\\IdeaProjects\\Progetto\\src\\C_MIPS_semantic.g:272:12: ( S_QUOTE ( DIGIT | CHAR | SLASH ( '0' | 'n' ) ) S_QUOTE )
			// C:\\GitHub\\unibg-compilers\\code\\IdeaProjects\\Progetto\\src\\C_MIPS_semantic.g:272:14: S_QUOTE ( DIGIT | CHAR | SLASH ( '0' | 'n' ) ) S_QUOTE
			{
			mS_QUOTE(); 

			// C:\\GitHub\\unibg-compilers\\code\\IdeaProjects\\Progetto\\src\\C_MIPS_semantic.g:272:22: ( DIGIT | CHAR | SLASH ( '0' | 'n' ) )
			int alt5=3;
			switch ( input.LA(1) ) {
			case '0':
			case '1':
			...
			switch (alt5) {
				...
				case 2 :
					...
					break;
				case 3 :
					// C:\\GitHub\\unibg-compilers\\code\\IdeaProjects\\Progetto\\src\\C_MIPS_semantic.g:274:10: SLASH ( '0' | 'n' )
					{
					mSLASH(); 
